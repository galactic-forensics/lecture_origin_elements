...
\begin{equation}
    E_\mathrm{coul} = k \frac{q_1 q_2}{r}.
\end{equation}
Here, $k=8.9876\times10^{9}$\,N\,m$^{2}$\,C$^{-2}$ is Coulomb's constant. 
