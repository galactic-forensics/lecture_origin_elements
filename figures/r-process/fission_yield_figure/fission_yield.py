...
data_u235 = fy_reader("fy_u238_500kev.txt")

# setup file names, etc.
fnames = ("fy_u235_500kev.txt", "fy_u238_500kev.txt", "fy_th232_500kev.txt")
labels = ("$^{235}$U", "$^{238}$U", "$^{232}$Th")
line_styles = ("-", "--", ":")
...
fig.text(0.15, 0.89, "$E_{n} = 500\\,$keV", ha="left")
